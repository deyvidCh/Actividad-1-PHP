...
<header>
  ...
  <div class="container-fluid">
    ...
    <input type="text" class="form-control" id="txt_id" value="0" readonly>
    <label for="lbl_codigo" class="form-label"><b>Codigo</label>
    <input type="text" class="form-control" id="txt_codigo" placeholder="Ej:E001" pattern="[E]{1}[0-9]{3}" require>
    <label for="lbl_nombres" class="form-label"><b>Nombres</label>
    <input type="text" class="form-control" id="txt_nombres" placeholder="Ej:Nombre 1 Nombre 2"require>
    <label for="lbl_apellidos" class="form-label"><b>Apellidos</label>
    <input type="text" class="form-control" id="txt_apellidos" placeholder="Ej:Apellido 1 Apellido 2"require>
    <label for="lbl_direccion" class="form-label"><b>Direccion</label>
    <input type="text" class="form-control" id="txt_direccion" placeholder="Ej:casa 23 zona 1"require>
    <label for="lbl_telefono" class="form-label"><b>Telefono</label>
    <input type="number" class="form-control" id="txt_telefono" placeholder="Ej:34567890"require>
    <label for="lbl_fn" class="form-label"><b>Nacimiento</label>
    <input type="date" class="form-control" id="txt_fn" placeholder="Ej:10/02/1997"require>
